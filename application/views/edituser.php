          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex flex-column align-items-center text-center">
                <img src="<?php echo base_url().$row['image'] ?>" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                <div class="mt-3">
                  <h4><?php echo $row['fullname'] ?></h4>
                  <p class="text-secondary mb-1"><?php echo $row['email'] ?></p>
                  <p class="text-muted font-size-sm"><?php echo $row['address'] ?></p>
                <!--   <form method="POST" enctype="multipart/form-data"> -->
                      <input type="hidden" name="oldphoto" value="<?php echo $row['image']?>">
                      <input type="file" name="image" style="border:5px solid #ccc; border-radius: 15px;border-style: outset;">
                      
                      <input type="submit" name="update1" value="Change Photo" class="btn btn-primary">
                     <!--  </form> -->
                </div>
              </div>
              <hr class="my-4">
            ...
            <div class="card-body">
              <div class="row mb-3">
                ...
                <div class="col-sm-9 text-secondary">
                  <input type="text" name="name" class="form-control" value="<?php echo $row['fullname']?>">
                </div>
              </div>
              <div class="row mb-3">
                <div class="col-sm-3">
