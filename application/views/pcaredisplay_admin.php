  ...
  <div class="col mb-4">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p class="card-text"><?php echo $row['Dprice'] ?></p>
       <a href="#" class="button1">Details</a>
       <!--  <button class="button button2">Cart</button> -->
       <a href="addtocartdata?name=<?php echo $row['Name'] ?> & price=<?php echo $row['Dprice'] ?> & photo=<?php echo $row['Image'] ?> & offer=<?php echo $row['Offer'] ?>" class="button button2">Cart</a>
