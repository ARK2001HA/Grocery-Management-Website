                        ...
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <tbody>
                                ...
                                <tr >
                                    ...
                                    <td><?php echo $row['Pcatagory']?></td>
                                    
                                  <td><img src="<?php echo base_url(). $row['Image']?>" height="100" width="100"></td>
                                    
                                    <td>
                                        <a href="updateadmincatagory?uid=<?php echo $row['Id']?>" class="btn btn-danger">Edit</a>
                                        <a href="deletecatadmin?delid=<?php echo $row['Id']?>" class="btn btn-info">Delete</a>
                                    </td>
                                </tr>
                                <?php
                                }
