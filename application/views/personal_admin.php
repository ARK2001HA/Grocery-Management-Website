          ...
          <div class="card-body p-4 p-md-5">
            ...
            <form class="px-md-2" method="post" enctype="multipart/form-data">
              ...
              <div class="form-outline mb-4">
                ...
                <input type="text" id="form3Example1q" name="pname" class="form-control" />
             
              </div>
               <div class="form-outline mb-4">
                   <label class="form-label" for="form3Example1q">Product Price</label>
                <input type="text" id="form3Example1q" name="pprice" class="form-control" />
             
              </div>
               <div class="form-outline mb-4">
                   <label class="form-label" for="form3Example1q">Product Discount Price</label>
                <input type="text" id="form3Example1q" name="pdisprice" class="form-control" />
              ...
              <input type="submit" name="submit" value="Insert" class="btn btn-success btn-lg mb-1">
