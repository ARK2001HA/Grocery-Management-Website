                    ...
                    <div class="container flex justify-between items-center">
                        <div class="icons">
                           <!--  <a href="#"><img src="<?php echo base_url() ?>./icons/facebook.svg" alt=""></a>
                            ...
                            <a href="#"><img src="<?php echo base_url() ?>./icons/instagram.svg" alt=""></a> -->
                             <a href="<?php echo base_url() ?>./index.php/Hellocontroller/userprofile"><i style="color:white" class="fa fa-user"></i></a>
                        ...
                        <div class="auth flex items-center">
                            ...
                            <div>
                                ...
                                <a href="<?php echo base_url() ?>./index.php/Hellocontroller/logout">LogOut</a>
                            </div>
                        </div>
                    </div>
                </header>
