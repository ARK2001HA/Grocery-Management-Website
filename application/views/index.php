                        ...
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Cust_Image</th>
                                    <th scope="col">Cust_Status</th>
                            ...
                            <tbody>
                                ...
                                <tr >
                                    ...
                                    <td>
                                        <a href="block?email=<?php echo $row['email']?>" class="btn btn-danger">Block</a>
                                        <a href="unblock?emailid=<?php echo $row['email']?>" class="btn btn-info">Unblock</a>
                                    </td>
                                </tr>
                                <?php
                                }
